...
It starts like the Helicopter Game in its core with the scrolling background and the player that collides with objects and adds to score.
But it is translated into 2D.
